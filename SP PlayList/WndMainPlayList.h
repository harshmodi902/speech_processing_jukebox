...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::Windows::Forms::ListViewItem^  listViewItem2 = (gcnew System::Windows::Forms::ListViewItem(L"item2"));
			...
			this->Test_Lang->Text = L"SPEAK Lang Index (5-7)";
			this->Test_Lang->UseVisualStyleBackColor = true;
			...
			this->live_train_index1->UseVisualStyleBackColor = false;
			...
			this->live_train_index2->UseVisualStyleBackColor = false;
			...
			this->live_train_index3->UseVisualStyleBackColor = false;
			...
			this->live_train_index4->UseVisualStyleBackColor = false;
			...
			this->button_speak_index->Text = L"Speak Song Index (0-4)";
			this->button_speak_index->UseVisualStyleBackColor = true;
			...
			// LIST_LANG_NAME
			// 
			this->LIST_LANG_NAME->Text = L"Language";
			this->LIST_LANG_NAME->Width = 184;
			// 
			// LIST_LANG_Lindex
			// 
			this->LIST_LANG_Lindex->Text = L"Index";
			// 
			// LiveTrain_Lang_new
			// 
			...
			this->LiveTrain_Lang_new->UseVisualStyleBackColor = false;
			...
			this->BackgroundImage = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"")));
			this->BackgroundImageLayout = System::Windows::Forms::ImageLayout::Stretch;
			this->ClientSize = System::Drawing::Size(934, 325);
			this->Controls->Remove(this->LiveTrain_Lang_new);
			this->Controls->Add(this->lang_listview);
			this->Controls->Add(this->label_playing_now);
			this->Controls->Remove(this->button_reset);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->button_speak_index);
			this->Controls->Remove(this->live_train_index4);
			this->Controls->Remove(this->live_train_index3);
			this->Controls->Remove(this->live_train_index2);
			this->Controls->Remove(this->live_train_index1);
			this->Controls->Remove(this->live_train_index0);
			...
			this->Controls->Remove(this->console_app_button);
			this->Controls->Add(this->lang_result);
			this->Controls->Add(this->Test_Lang);
			this->Controls->Remove(this->liveTrain_English);
			this->Controls->Remove(this->liveTrain_hindi);
			this->Controls->Add(this->Label_Lang_English);
			this->Controls->Add(this->Label_Lang_Hindi);
			this->Controls->Remove(this->picture_boy);
			...
			this->Icon = (cli::safe_cast<System::Drawing::Icon^  >(resources->GetObject(L"")));
...
// when forms Loads
	private: System::Void WndMainPlayList_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		this->LABEL_SONG0->Text = L"Song-0: ";
		this->LABEL_SONG1->Text = L"Song-1: ";
		this->LABEL_SONG2->Text = L"Song-2: ";
		this->LABEL_SONG3->Text = L"Song-3: ";
		this->LABEL_SONG4->Text = L"Song-4: ";
...
//SPEAK LANG CODE
	private: System::Void speak_lang_Click_1(System::Object^  sender, System::EventArgs^  e) {
		...
		printf("\n <-------->");
		printf("\n Duration 3 sec: RECORDING LANGUAGE: \n");
